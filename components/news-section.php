...
<div id="news-section" class="w-full bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-md">
            ...
            <div class="relative group bg-gray-100 dark:bg-gray-800 p-4 rounded-xl transition hover:shadow-lg">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400 mt-2">
                        <span>
                            🗓 <?= date("M j, Y") ?> • ✍️ Author <?= $i + 1 ?> • 🗞 Source <?= $i + 1 ?>
                        </span>
    ...
    <div class="mt-6 text-center">
        <button id="loadMoreNews" class="px-6 py-2 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition duration-300">
            🔄 Load More news here
        </button>
    </div>

    <!--1.1 Load More  but needed-->
    <div class="mt-6 text-center">
